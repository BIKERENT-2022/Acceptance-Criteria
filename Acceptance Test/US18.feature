...
Then podré visualizar las peticiones de alquiler de bicicletas de los clientes, y así realizarlo luego de mi confirmación.

Scenario: Revisión de solicitudes no exitoso.
Given me encuentro en la interfaz de reserva
When seleccione la opción de solicitudes y este no cargue o se ralentice
