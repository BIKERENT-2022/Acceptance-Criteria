...
When ingrese los datos nuevos de forma correcta (sin dejar espacios en blanco e información verdadera)
...
Given me encuentro en el interfaz de actualización de datos
When ingrese los datos nuevos de forma incorrecta (dejando información en blanco y falsa)
